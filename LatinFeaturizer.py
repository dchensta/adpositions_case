...
class LatinFeaturizer(metaclass=abc.ABCMeta):
    @abc.abstractclassmethod
    def featurize(self):
        pass

class BERTFeaturizer(LatinFeaturizer):
    def __init__(self):       
        self.model = "latin-bert-master/"
        self.tokenizer = "latin-bert-master/"
